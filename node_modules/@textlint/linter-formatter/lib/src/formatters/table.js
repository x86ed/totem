...
function formatter(report, options) {
    ...
    output += `\n${(0, table_1.table)([[chalk_1.default.red((0, pluralize_1.default)("Error", errorCount, true))], [chalk_1.default.yellow((0, pluralize_1.default)("Warning", warningCount, true))]], {
        columns: {
            0: {
                width: 110,
                wrapWord: true
